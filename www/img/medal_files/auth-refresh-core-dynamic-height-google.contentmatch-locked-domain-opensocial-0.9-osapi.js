...
(function(){var c=this;var e;a:{var f=c.navigator;if(f){var h=f.userAgent;if(h){e=h;break a}}e=""}var k=function(a){return-1!=e.indexOf(a)};var l=k("Opera"),m=k("Trident")||k("MSIE"),n=-1!=e.toLowerCase().indexOf("webkit")&&!k("Edge");var r=k("Safari")&&!((k("Chrome")||k("CriOS"))&&!k("Edge")||k("Coast")||k("Opera")||k("Edge")||k("Silk")||k("Android"))&&!(k("iPhone")&&!k("iPod")&&!k("iPad")||k("iPad")||k("iPod"));var t=null,u=null,x=k("Gecko")&&!(-1!=e.toLowerCase().indexOf("webkit")&&!k("Edge"))&&!(k("Trident")||k("MSIE"))&&!k("Edge")||n&&!r||l||!r&&!m&&"function"==typeof c.atob,z=function(a){if(x)return c.atob(a);var b="";y(a,function(a){b+=String.fromCharCode(a)});return b},y=function(a,b){function d(b){for(;p<a.length;){var d=a.charAt(p++),g=u[d];if(null!=g)return g;if(!/^[\s\xa0]*$/.test(d))throw Error("Unknown base64 encoding at char: "+d);}return b}A();for(var p=0;;){var v=d(-1),w=d(0),g=d(64),q=d(64);
if(64===q&&-1===v)break;b(v<<2|w>>4);64!=g&&(b(w<<4&240|g>>2),64!=q&&b(g<<6&192|q))}},A=function(){if(!t){t={};u={};for(var a=0;65>a;a++)t[a]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(a),u[t[a]]=a,62<=a&&(u["ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_.".charAt(a)]=a)}};var B=function(a){return/^\s*$/.test(a)?!1:/^[\],:{}\s\u2028\u2029]*$/.test(a.replace(/\\["\\\/bfnrtu]/g,"@").replace(/(?:"[^"\\\n\r\u2028\u2029\x00-\x08\x0a-\x1f]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?)[\s\u2028\u2029]*(?=:|,|]|}|$)/g,"]").replace(/(?:^|:|,)(?:[\s\u2028\u2029]*\[)+/g,""))},C=function(a){a=String(a);if(B(a))try{return eval("("+a+")")}catch(b){}throw Error("Invalid JSON string: "+a);};var D=function(a){if(window._debugCob)return window._debugCob;var b=gadgets.util.getUrlParameters().cob;if(b){b=decodeURIComponent(b);"{"!=b.charAt(0)&&(b=z(b));b=C(b);if(a)return b[a];a=[];for(var d in b)a=a.concat(b[d]);return a}return[]},E=function(a){var b;if(gadgets.views&&gadgets.views.getParams()){b=gadgets.views.getParams();var d=!1,p;for(p in b){d=!0;break}b=d?"list"in b?b.list:[b]:null}else b=null;return b||D(a)},F=["google","contentmatch","getContentMatches"],G=c;
F[0]in G||!G.execScript||G.execScript("var "+F[0]);for(var H;F.length&&(H=F.shift());)F.length||void 0===E?G=G[H]&&G[H]!==Object.prototype[H]?G[H]:G[H]={}:G[H]=E;}).call(this);
;
